...
/**************************************************************/
static inline void
__initialize_with_null(char *buf, int size) {
	int i = 0;
...
/*This method has been taken from the ecryptfs implementation*/
static inline struct vfsmount *
wrapfs_dentry_to_lower_mnt(struct dentry *dentry)
{
return ((struct wrapfs_dentry_info *)dentry->d_fsdata)->lower_path.mnt;
}
extern int calculate_integrity(struct file *filp, char *ibuf, int ilen);
/**************************************************************/
